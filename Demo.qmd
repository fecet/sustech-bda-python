---
title: Python EDA & Classification
format:
  html:
    code-fold: true
jupyter: python3
...
```{python}
#| ExecuteTime: {end_time: '2023-06-11T05:55:40.722617Z', start_time: '2023-06-11T05:55:39.899939Z'}
import warnings
...
```{python}
#| ExecuteTime: {end_time: '2023-06-11T05:55:40.731777Z', start_time: '2023-06-11T05:55:40.726489Z'}
from pathlib import Path
if not Path("heart.csv").exists():
    os.system("wget https://github.com/fecet/sustech-bda-python/raw/master/heart.csv")
data = pd.read_csv("heart.csv")
print("Shape of the data is ", data.shape)
```

```{python}
#| ExecuteTime: {end_time: '2023-06-11T05:55:40.746497Z', start_time: '2023-06-11T05:55:40.733366Z'}
data.head()
```

```{python}
#| ExecuteTime: {end_time: '2023-06-11T05:55:40.751290Z', start_time: '2023-06-11T05:55:40.747756Z'}
data.dtypes
```
...
```{python}
#| ExecuteTime: {end_time: '2023-06-11T05:55:40.757764Z', start_time: '2023-06-11T05:55:40.752979Z'}
...
```{python}
#| ExecuteTime: {end_time: '2023-06-11T05:55:40.763296Z', start_time: '2023-06-11T05:55:40.759515Z'}
data = data.rename(
    columns={
        "cp": "chest_pain_type",
...
```{python}
#| ExecuteTime: {end_time: '2023-06-11T05:55:40.795369Z', start_time: '2023-06-11T05:55:40.765029Z'}
...
```{python}
#| ExecuteTime: {end_time: '2023-06-11T05:55:40.801146Z', start_time: '2023-06-11T05:55:40.797896Z'}
data.dtypes
```

```{python}
#| ExecuteTime: {end_time: '2023-06-11T05:55:40.812328Z', start_time: '2023-06-11T05:55:40.802373Z'}
data.head()
```
...
```{python}
#| ExecuteTime: {end_time: '2023-06-11T05:55:40.817315Z', start_time: '2023-06-11T05:55:40.814000Z'}
...
```{python}
#| ExecuteTime: {end_time: '2023-06-11T05:55:40.967762Z', start_time: '2023-06-11T05:55:40.818971Z'}
...
```{python}
#| ExecuteTime: {end_time: '2023-06-11T05:55:40.990817Z', start_time: '2023-06-11T05:55:40.969437Z'}
...
```{python}
#| ExecuteTime: {end_time: '2023-06-11T05:55:42.189744Z', start_time: '2023-06-11T05:55:40.992635Z'}
L = len(num_feats)
ncol = 2
...
```{python}
#| ExecuteTime: {end_time: '2023-06-11T05:55:45.799103Z', start_time: '2023-06-11T05:55:42.191703Z'}
_ = [
    "age",
    "cholesterol",
    "resting_blood_pressure",
...
```{python}
#| ExecuteTime: {end_time: '2023-06-11T05:55:51.984016Z', start_time: '2023-06-11T05:55:45.801305Z'}
...
```{python}
#| ExecuteTime: {end_time: '2023-06-11T05:55:53.209979Z', start_time: '2023-06-11T05:55:51.985546Z'}
...
```{python}
#| ExecuteTime: {end_time: '2023-06-11T05:55:53.423872Z', start_time: '2023-06-11T05:55:53.211589Z'}
df_ = data[num_feats]
...
```{python}
#| ExecuteTime: {end_time: '2023-06-11T05:55:53.659868Z', start_time: '2023-06-11T05:55:53.425547Z'}
feats_ = [
    "age",
    "cholesterol",
    "resting_blood_pressure",
...
```{python}
#| ExecuteTime: {end_time: '2023-06-11T05:55:54.167649Z', start_time: '2023-06-11T05:55:53.661316Z'}
...
```{python}
#| ExecuteTime: {end_time: '2023-06-11T05:55:54.264856Z', start_time: '2023-06-11T05:55:54.169274Z'}
...
```{python}
#| ExecuteTime: {end_time: '2023-06-11T05:55:54.278935Z', start_time: '2023-06-11T05:55:54.266871Z'}
...
```{python}
#| ExecuteTime: {end_time: '2023-06-11T05:55:54.292156Z', start_time: '2023-06-11T05:55:54.281591Z'}
...
```{python}
#| ExecuteTime: {end_time: '2023-06-11T05:55:54.309799Z', start_time: '2023-06-11T05:55:54.293834Z'}
...
```{python}
#| ExecuteTime: {end_time: '2023-06-11T05:55:55.241348Z', start_time: '2023-06-11T05:55:54.311322Z'}
num = 100
...
```{python}
#| ExecuteTime: {end_time: '2023-06-11T05:55:55.246838Z', start_time: '2023-06-11T05:55:55.243045Z'}
...
```{python}
#| ExecuteTime: {end_time: '2023-06-11T05:55:56.339967Z', start_time: '2023-06-11T05:55:55.251445Z'}
(
...
```{python}
#| ExecuteTime: {end_time: '2023-06-11T05:55:57.665781Z', start_time: '2023-06-11T05:55:56.342106Z'}
